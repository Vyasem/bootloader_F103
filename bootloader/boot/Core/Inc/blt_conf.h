...
/****************************************************************************************
*   A D V A N C E D   C H E C K S U M   C O N F I G U R A T I O N
****************************************************************************************/
/* The bootloader can verify the checksum of the user program by setting
 */
#define ADDON_CHECKSUM_MOD_ENABLE       (1)
#define ADDON_CHECKSUM_MOD_TABLE_SIZE_BYTES (0x200)
#define ADDON_CHECKSUM_MOD_TABLE_ADDR   (0x08000000 + BOOT_NVM_SIZE_KB * 0x400 - ADDON_CHECKSUM_MOD_TABLE_SIZE_BYTES)
